...
if (
    ...
    || trim(strip_tags($postData['title'])) === '' //trim enlève les espaces blancs au début et à la fin
    || trim(strip_tags($postData['recipe'])) === '' //strip_tags enlève les balises html pour prévenir les attaques XSS
) {
...
$insertRecipe->execute([
    'title' => $title,
    'recipe' => $recipe,
    'is_enabled' => 1,  //1 pour vrai; 0 pour faux
    // Si TRUE et FALSE directement il faudra déclarer le champ  is_enabled avec le type MySQL BOOL

    'author' => $_SESSION['LOGGED_USER']['email'],
]);
//Pas de valeur pour le champ recipe_id car avec AUTO_INCREMENT, MySQL lui attribuera une valeur automatiquement
